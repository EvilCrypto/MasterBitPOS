...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterBitPOS Core masterbitpos-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masterbitpos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masterbitpos transaction") + "\n" +
                               "  masterbitpos-tx [options] -create [commands]   " + _("Create hex-encoded masterbitpos transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masterbitpos transaction
