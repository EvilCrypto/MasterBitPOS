...
/* MasterBitPOS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MasterBitPOS"
#define QAPP_ORG_DOMAIN "masterbitposcoin.io"
#define QAPP_APP_NAME_DEFAULT "MasterBitPOS-Qt"
#define QAPP_APP_NAME_TESTNET "MasterBitPOS-Qt-testnet"
