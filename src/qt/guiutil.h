...
/** Utility functions used by the MasterBitPOS Qt UI.
 */
namespace GUIUtil
{
...
// Render MasterBitPOS addresses in monospace font
...
// Parse "masterbitpos:" URI into recipient object, return true on successful parsing
