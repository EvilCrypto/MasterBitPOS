...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterBitPOS Core"),
     ...
     * override -datadir in the masterbitpos.conf file in the default data directory
     * (to be consistent with masterbitposd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
