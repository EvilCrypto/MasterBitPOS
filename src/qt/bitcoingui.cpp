                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MasterBitPOS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MasterBitPOS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and masterbitpos: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMBPOS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MasterBitPOS Core"), this);
    aboutAction->setStatusTip(tr("Show information about MasterBitPOS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasterBitPOS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MasterBitPOS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MasterBitPOS addresses"));
    ...
    openAction->setStatusTip(tr("Open a MasterBitPOS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MasterBitPOS Core help message to get a list with possible MasterBitPOS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MasterBitPOS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterBitPOS network", "", count));
}
...
{
    QString strTitle = tr("MasterBitPOS Core"); // default title
