...
In order to support loading of multiple wallets in masterbitpos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is masterbitpos.cpp.
...
Changes to masterbitpos.cpp
----------------------
masterbitpos.cpp is the entry point into masterbitpos-qt, and as such, will require some minor modifications to provide hooks for
