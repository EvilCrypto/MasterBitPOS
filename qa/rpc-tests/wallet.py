...
#   c) node1 mines 32 blocks, so now node 0 has 60001mbpos, node 1 has 4250mbpos, node2 has none.
#   d) node0 sends 601 mbpos to node2, in two transactions (301 mbpos, then 300 mbpos).
