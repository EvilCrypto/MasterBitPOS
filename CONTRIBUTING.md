Contributing to MasterBitPOS Core
============================

The MasterBitPOS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterBitPOS Core project, and is not to be
confused with overall MasterBitPOS Network Protocol consensus changes.

Whether a pull request is merged into MasterBitPOS Core rests with the project merge
...
Patches that change MasterBitPOS consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasterBitPOS consensus, it must have been
...
The project leader is the release manager for each MasterBitPOS Core release.
